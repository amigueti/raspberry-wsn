...
#                print p + "\t...\t" + output.replace('\r', '\n').rstrip()
                print p[:4] + "\t...\t" + output.replace('\r', '\n').rstrip()
