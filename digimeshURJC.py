    ...
    api_commands = {"at":
                    ...
                    "tx":
                        [{'name':'id',              	'len':1,        'default':'\x10'},
                         ...
                         {'name':'options',         	'len':1,        'default':'\xC1'},
                         {'name':'app_id',         	'len':1,        'default':None},
                         {'name':'frag_num', 	        'len':1,        'default':'\x01'},
                         {'name':'separator',   	'len':1,        'default':'\x23'},
                         {'name':'source_type',         'len':1,        'default':'\x00'},
                         {'name':'source_id',		'len':2,        'default':'\x00\x01'},
		    ...
		    "ack":
                        [{'name':'id',                  'len':1,        'default':'\x10'},
                         ...
                         {'name':'source_type',         'len':1,        'default':'\x00'},
                         {'name':'source_id',           'len':2,        'default':'\x00\x01'},
			 {'name':'ack_seq',             'len':1,        'default':None},
			 {'name':'separator',           'len':2,        'default':'\x2D\x2F'},
			 {'name':'ack_estado',          'len':1,        'default':None},
			 {'name':'separator',           'len':2,        'default':'\x2D\x2F'}],
                    }
                        ...
                        {'name':'rx',
                         'structure':
                            [{'name':'frame_id',    	'len':1},
                             ...
                             {'name':'reserved',    	'len':2},
                             {'name':'options',     	'len':1},
                             {'name':'application_id',	'len':1},
                             {'name':'frag_num',        'len':1},
                             {'name':'delimitor',       'len':1,	'default':'\x23'},
                             {'name':'source_type',     'len':1},
                             {'name':'source_id',       'len':2},
                             {'name':'data',        	'len':None}]},
                    # b"\x91": to do!
